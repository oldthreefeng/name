LDFLAGS += -X "github.com/oldthreefeng/name/cmd.Buildstamp=$(shell date -u '+%Y-%m-%d %H:%M:%S %Z')"
LDFLAGS += -X "github.com/oldthreefeng/name/cmd.Githash=$(shell git rev-parse --short HEAD)"
LDFLAGS += -X "github.com/oldthreefeng/name/cmd.Goversion=$(shell go version)"
